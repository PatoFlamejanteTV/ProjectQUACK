	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [
			...
			[
				'Jordan Santiago',
				'jor',
				'Coded everything into JS Engine',
				'https://twitter.com/JordansTweetsYT',
				'FF9300'
			],
			[
				'Stinko',
				'stinkern',
				'Coder, a very stupid one..',
				'https://stinkernn.carrd.co/',
				'555555'
			],
			...
			[
				'Denpa Engine',
				'denpeak',
				'The crossfade code used for this engine\n(Currently not implemented yet!)',
				'https://github.com/UmbratheUmbreon/PublicDenpaEngine',
				'FF9300'
			],
			[
				'HRK. EXEX',
				'hrk',
				'Created the Old Video Rendering Mode for FNF & the Note Skipping idea,\nalong with the Rating Popup recycling idea thing',
				'https://www.youtube.com/@HRK_EXEX/featured',
				'01F8FF'
			],
			[
				'cabfile',
				'cabfile',
				'Created the new Video Rendering Mode for FNF',
				'https://github.com/cabfile',
				'DDDDDD'
			],
			[
				'SomeGuyWhoLovesCoding',
				'sgwlc',
				'Rewrote the chart loading system and ported the new Rendering Mode to source',
				'https://www.youtube.com/channel/UCMSusVA3DY-4EtiGP4zKAJA',
				'FFBD40'
			],
			[
				'Betopia',
				'nothing',
				'Freeplay Search bar creator',
				'https://www.youtube.com/channel/UCfjyz9xRhZiRbLMteQloVeg',
				'FFFFFF'
			],
			[
				'CDEV Engine',
				'cdev',
				'Update Screen Creator',
			...
			[
				'NotMagniill',
				'magniill',
				'Code for the Sustain Note Splashes',
				'https://github.com/notmagniill',
				'FFBD40'
			],
			[
				'chromasen',
				'chromasen',
				'Code for the Windows Notification Event',
			...
			[
				'Erizur',
				'erizur',
				'Cross-Platform code for the Windows Notification Event',
			...
			[
				'Slushi (Andres)',
				'slushi',
				'Actual working code for the Windows Notification Event',
				'https://github.com/Slushi-Github/Slushi-Engine/tree/main',
				'8FD9D1'
			],
			[
				'Nael2xd',
				'nael',
				'Revamped Note Multiplier, Fixed Windows Notifications, Improved Chart Editor Autosave and UI for Crash State',
				'https://www.youtube.com/@Nael2xd',
				'880000'
			],
			[''],
			['Psych Engine Team'],
